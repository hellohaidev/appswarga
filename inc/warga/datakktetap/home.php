...
if(isset($_POST['save'])){
    ...
    $queryInsert = mysqli_query($link,"insert into tm_data_kk_tetap
...
?>
        ...
        <table class="table table-bordered display" id="data" width="100%">
            ...
            <tbody>
            <?php
                $querySelect = mysqli_query($link,"select * from tm_data_kk_tetap");
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?page=editkktetap&id=<?php echo $row['id_kk_tetap'] ?>" class="btn btn-info">Edit</a>  <a href="?page=deletekktetap&id=<?php echo $row['id_kk_tetap'] ?>" class="btn btn-danger">Delete</a>  <a href="?page=viewkktetap&id=<?php echo $row['id_kk_tetap'] ?>" class="btn btn-primary">View</a>
                    </td>
