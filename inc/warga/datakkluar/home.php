...
if(isset($_POST['save'])){
    ...
    $queryInsert = mysqli_query($link,"insert into tm_data_kk_luar
...
?>
        ...
        <table class="table table-bordered display" id="data" width="100%">
            ...
            <tbody>
            <?php
                $querySelect = mysqli_query($link,"select * from tm_data_kk_luar");
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?page=editkkluar&id=<?php echo $row['id_kk_luar'] ?>" class="btn btn-info">Edit</a>  <a href="?page=deletekkluar&id=<?php echo $row['id_kk_luar'] ?>" class="btn btn-danger">Delete</a>  <a href="?page=viewkkluar&id=<?php echo $row['id_kk_luar'] ?>" class="btn btn-primary">View</a>
                    </td>
