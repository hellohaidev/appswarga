...
if(isset($_POST['save'])){
    ...
    $queryInsert = mysqli_query($link,"insert into tm_data_kk
...
?>
        ...
        <table class="table table-bordered display" id="data" width="100%">
            ...
            <tbody>
            <?php
                $querySelect = mysqli_query($link,"select * from tm_data_kk");
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?page=editkk&id=<?php echo $row['id_kk'] ?>" class="btn btn-info">Edit</a>  <a href="?page=deletekk&id=<?php echo $row['id_kk'] ?>" class="btn btn-danger">Delete</a>  <a href="?page=viewkk&id=<?php echo $row['id_kk'] ?>" class="btn btn-primary">View</a>
                    </td>
